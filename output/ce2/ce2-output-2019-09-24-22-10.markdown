...
!
! Last configuration change at 12:10:01 UTC Mon Sep 16 2019 by root
!
version 15.6
...
interface GigabitEthernet0/0
 vrf forwarding ISP1
 ip address 10.14.14.2 255.255.255.0
 duplex auto
 speed auto
 media-type rj45
!
...
interface GigabitEthernet0/3
 ip address 10.122.30.14 255.255.0.0
 duplex full
 speed auto
 media-type rj45
!
...
ip route vrf ISP1 0.0.0.0 0.0.0.0 10.14.14.1
ip route vrf ISP2 0.0.0.0 0.0.0.0 10.17.17.1
!
!
ip prefix-list PREF_LOCAL_NET seq 5 permit 172.16.2.0/24
!
